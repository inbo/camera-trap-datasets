...
deployments(raw_data) %>%
  filter(deploymentID == "0427b248-2e3d-4028-b3ce-dc8f5aefbe0c") %>% 
  select(deploymentID, locationName, deploymentStart, deploymentEnd)
```
...
```{r}
observations(raw_data) %>%
  filter(deploymentID == "d0cb880b-8f5d-446b-b558-836eaffc4f31")
```
...
```{r}
observations(raw_data) %>%
  filter(deploymentID == "f22c4374-20e6-4b17-818e-6129d0cd3611")
```
