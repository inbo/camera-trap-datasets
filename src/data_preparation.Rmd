...
Issue: from 2021-12-13 10:30:00, each image became a single sequence, and the series also stopped abruptly.

Ignored. Accepted as noise. The end date of the deployment reflects the premature stop.
...
Issue: not set up to take a photo at noon and midnight.
...
Issues:
- image not identical to deployments before the storm
- image not stable during deployment.

Ignored. Accepted as noise.

### VOR18a -- 2022-05-03--2022-05-31

Issue: failed prematurely on 2022-05-07.
...
### INS11 -- 2024-04--2024-05
 ...
 Issue: problematic in various aspects.
- Set to daylight saving time instead of standard time (but the correction has already been made in Agouti).
- Sequence creation is incorrect (sequences of 10 are often split).
...
Marked as 'invalid' in Agouti. Could theoretically be cleaned up (time-consuming).
...
Issue: damaged in a storm on 2022-02-18-17-31. But it initially continued to operate. DeploymentEnd will be adjusted, and observations after this time will be removed.
...
Issue: incorrect time setting throughout the campaign. Retroactively determined, it must have been installed at approximately "2022-12-05 13:40:00" (+ 11.87361 hours) during the initial setup.
...
### Fix PEE11=INS05 -- 2023--2024
 ...
 Issue: incorrect time setting throughout the campaign. Retroactively determined, it must have been installed at approximately "2023-11-21 11:44:00" during the initial setup.
...
Problematic. Pros and cons. → It would be wisest to remove it completely (?)
