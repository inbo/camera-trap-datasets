...
current_VOR23b <- "2022-12-05 01:47:35"
new_VOR23b <- "2022-12-05 13:40:00"
duration_VOR23b <- lubridate::as.duration(lubridate::interval(current_VOR23b, new_VOR23b))

clean_data <-
  clean_data %>%
  camtrapdp::shift_time(
    deployment_id = "8de6a0a1-9308-4d99-8a71-e2a2c710739d",
    duration = duration_VOR23b
  ) %>%
  camtrapdp::shift_time(
...
current_PEE11 <- "2023-11-22 00:04:41"
new_PEE11 <- "2023-11-21 11:44:00"
duration_PEE11 <- lubridate::as.duration(lubridate::interval(current_PEE11, new_PEE11))
...
# Keywords
muntjac$keywords <- c("camera traps", "alien species", "Flanders, Belgium", "Mammalia", "birds", "Lifewatch", "Chinese muntjac", "Muntiacux reevesi", "invasive alien species")
...
eml$dataset$metadataProvider <- EML::set_responsibleParty(
  ...
  userId = "https://orcid.org/0000-0002-8939-1305"
)
