...
```{r camtrap data}
name_exportfolder <- "muntjacantwerp-20260305150639"
...
agouti_id <- "52a7408e-b49a-4b80-a427-d1b44b31ac5c"
```
...
VOR18b | 2024-11 -- 2025-01 | Prematurely failed.
INS05 | 2024-11 -- 2025-01 | Prematurely failed.
INS03 | 2025-01 -- 2025-02 | Defective. No sequence obtained.
VOR07b | 2025-02 -- 2025-04 | Defective. No sequence obtained.
INS02 | 2025-02 -- 2025-04 | Prematurely failed (just short of pick-up).
INS03 | 2025-02 -- 2025-04 | Prematurely failed (just short of pick-up).
INS07 | 2025-04 -- 2025-05 | Defective. No sequence obtained.
VOR05b | 2025-04 -- 2025-05 | Defective. No sequence obtained.
VOR22b | 2025-04 -- 2025-05 | Defective. No sequence obtained.
INS06 | 2025-04 -- 2025-05 | Prematurely failed (just short of pick-up).
...
VOR06b | 2024-11 -- 2025-01 | Small branch for the camera.
...
VOR10b | 2024-12 -- 2025-02 | Many blanks, oddly enough at particular times (XX:03:01, XX:33:01...). Nonetheless, movement is detected. | No action required.
...
"44db5bbe-2f78-420b-8eb7-1bf462196b47" | INS07 | 2025-02 -- 2025-04 | Although there were recordings up until readout, clock has stopped since 2025-02-21. Problematic. Pros and cons. Seems wisest to remove it completely.
...
deploymentID_to_remove <- c(
  ...
  "44db5bbe-2f78-420b-8eb7-1bf462196b47"
)
...
dataset$description <- paste(
  paste0("<emphasis>", dataset$title, "</emphasis> is a camera trap dataset published by the <ulink url=\"https://www.inbo.be/en\"><citetitle>Research Institute for Nature and Forest (INBO)</citetitle></ulink>. It contains camera trapping data collected for the monitoring of Chinese muntjac (<emphasis>Muntiacus reevesi</emphasis>) in the Region of Flanders with respect to Regulation EU nr. 1143/2014. The monitoring is performed in close collaboration with the Agency for Nature and Forest (ANB). Several forest areas east of Antwerp were sampled for animal wildlife, since Chinese muntjac is known to occur in the wider region since about 2012. The main area of study is Park Vordenstein, a government-owned woodland park that is open to the public. Camera traps were installed per forest area, in northerly direction at a height of about 50 cm. The number of camera traps varied per area and per year. Images from the camera traps were uploaded to <ulink url=\"https://www.agouti.eu\"><citetitle>Agouti</citetitle></ulink> for data annotation. All observations of muntjac were double-checked in the framework of further analyses. Issues with the dataset can be reported at <ulink url=\"https://github.com/inbo/camera-trap-datasets/issues\"><citetitle>https://github.com/inbo/camera-trap-datasets/issues</citetitle></ulink>."),
...
# Add project acronym
dataset$project$acronym <- "MUNTJAC_ANTWERP"
```
