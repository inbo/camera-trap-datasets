...
gmu8_leuven$description <- c(
  paste(
    gmu8_leuven$title, "is a dataset published by the Research Institute of Nature and Forest (INBO). It contains camera trap data primarily collected within the framework of monitoring the recolonization of wild boar in natural areas south of Leuven. However, the dataset includes all recorded observations of mammals and birds captured during the monitoring period.",
    ...
    All images captured by the camera traps were uploaded to Agouti for data annotation. Issues with the dataset can be reported at https://github.com/inbo/camera-trap-datasets/issues.",
    "We have released this dataset to the public domain under a Creative Commons Zero waiver. We kindly ask users to follow the INBO norms for data use (https://www.inbo.be/en/norms-data-use) when using the data. If you have any questions regarding this dataset, don't hesitate to contact us via the contact information provided in the metadata or via opendata@inbo.be. Researchers can request more detailed geographic coordinates of the camera trap locations, or more information regarding the ongoing research based on these camera traps by contacting jim.casaer@inbo.be.",
...
# Keywords
gmu8_leuven$keywords <- c("camera traps","ungulates","roe deer","wild boar","widllife management", "alien species", "Flanders, Belgium", "mammalia", "birds", "Lifewatch", "invasive alien species", "European observatory of wildlife","Nationaal Park Brabantse Wouden")
