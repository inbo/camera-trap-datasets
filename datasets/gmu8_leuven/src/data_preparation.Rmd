...
```{r}
embargo_date <- Sys.Date() %m-% months(12)
```
...
# Keywords
dataset$keywords <- c("camera traps","ungulates","roe deer","wild boar","widllife management", "alien species", "Flanders, Belgium", "mammalia", "birds", "Lifewatch", "invasive alien species", "European observatory of wildlife","Nationaal Park Brabantse Wouden")
