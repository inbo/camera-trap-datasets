...
rounded_data <-
  data %>% 
  camtrapdp::round_coordinates(digits = 2) # Jim: beslissing
```

### Set embargo

Set an embargo on the last 6 months. Before this date, all data is public. After this date, only observations of exotic species are kept.
